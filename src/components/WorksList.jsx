...
//import WorksListJson from "../json/WorksList.json" //20231119 優化掉，直接讀後台Api
import { getWorksList } from "../api";

export default function WorksList({ school, semester }) {
    //20231119 優化成初始狀態為空陣列
    ...
    // 20231119 使用 useEffect 来獲取列表數據，維持非同步的處理。非同步的意思是組件絢染與資料串接非同步
    useEffect(() => {  
